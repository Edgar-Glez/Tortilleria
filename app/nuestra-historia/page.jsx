          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div>
              ...
              <p className="mt-3 text-xl text-gray-500 sm:mt-4 text-justify">
                ...
                años la inauguración de la exitosa tortillería Real del Maíz por
                su esposa Adela Esquivel. Ahora, su hijo menor junto con su
                pareja, continúan el legado familiar con la motivación de lograr
                la mejor tortilla de maíz de Ensenada para honrar la memoria de
                sus padres.
              </p>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base text-gray-500 text-justify">
                    Tortillería Valle Verde es un negocio familiar con más de 40
                    años de experiencia en la producción de tortillas de maíz y
                    harina en Ensenada. Con ingredientes frescos y técnicas
                    tradicionales, honramos el legado de nuestros padres y
                    abuelos. Nos enorgullece satisfacer a nuestros clientes y
                    comprometernos con la comunidad local.
                  </p>
                </div>
              </div>
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base text-gray-500 text-justify">
                    ...
                    mejores tortillas de maíz y harina en Ensenada, manteniendo
                    las tradiciones familiares y utilizando ingredientes
                    naturales. Buscamos la satisfacción de nuestros clientes y
