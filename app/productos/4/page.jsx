  ...
  return (
    <div className="text-center flex flex-col items-center">
      ...
      <p className="text-base text-gray-500">
        Dos docenas de tortillas de harina es un paquete perfecto para aquellos
        que buscan una opción conveniente y deliciosa para satisfacer sus
        antojos de comida mexicana. Este paquete contiene 24 tortillas de
      ...
      <p className="text-base text-gray-500">
        ...
        burritos y quesadillas hasta tacos y fajitas. Además, son muy fáciles de
