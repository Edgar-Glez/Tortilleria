  ...
  return (
    <div className="text-center flex flex-col items-center">
      ...
      <p className="text-base text-gray-500">
        Media docena de tortilla de maíz es un paquete práctico y delicioso para
        aquellos que buscan una opción conveniente para preparar sus platillos
        mexicanos favoritos. Este paquete contiene 6 tortillas de maíz,
      ...
      <p className="text-base text-gray-500">
        Este paquete de media docena de tortilla de maíz es ideal para aquellos
        que buscan disfrutar de la autenticidad de la cocina mexicana en
        pequeñas cantidades. Es perfecto para hogares pequeños, estudiantes,
