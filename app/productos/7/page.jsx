    ...
    <div className="h-screen flex flex-col justify-center items-center bg-[#F6EFD5]">
      <div className="productos-container text-justify flex flex-col items-center flex-1">
        ...
        <p className="text-base text-gray-500">
          ...
          platillos mexicanos favoritos. Este paquete contiene 36 tortillas de
        ...
        <p className="text-base text-gray-500">
          Este paquete de tres docenas de tortilla de maíz es ideal para
          aquellos que buscan disfrutar de la autenticidad de la cocina mexicana
          en grandes cantidades. Es perfecto para hogares grandes, reuniones
          familiares, fiestas y cualquier evento en el que se desee servir
          platillos mexicanos.
        </p>
